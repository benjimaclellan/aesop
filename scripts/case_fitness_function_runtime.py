...
BIT_WIDTH = 1 # 1 samples for 1 bit
EXPONENTS_TO_TEST = range(0, 24) # we shall test bit lengths which are powers of two between [8, 2^32)
FUNCTIONS_TO_TEST_STR = ['l1', 'l2', 'max eye', 'BER pure alternate']
...
for i in EXPONENTS_TO_TEST:
    ...
    evaluator = CaseEvaluator(propagator, bit_seq, BIT_WIDTH)
