...
if __name__ == "__main__":
    ...
    x_ticks = [i for i in range(len(params_ga[0]))]
    ...
    params = params_rs + params_ga
    scores = scores_rs + scores_ga
    ...
    for parameters, score in zip(params, scores):
        ...
        ax.plot(x_ticks, parameters_scaled, ls='', marker='o')#, color=colormap[scale])
