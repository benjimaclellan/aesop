...
from assets.functions import extractlogbook, save_experiment, load_experiment, reload_experiment
...
from classes.components import Fiber, AWG, PhaseModulator, WaveShaper, PowerSplitter, FrequencySplitter
...
#
#     muv = exp.attributes_to_list()
#     sigma_list = exp.get_sigma_list()
#     H0 = Hf(muv)
